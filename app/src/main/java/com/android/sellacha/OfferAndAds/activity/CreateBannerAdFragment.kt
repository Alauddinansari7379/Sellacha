...
class CreateBannerAdFragment : Fragment(), UploadRequestBody.UploadCallback {
    var binding: FragmentCreateBannerAdBinding? = null
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_create_banner_ad, container, false)
    }

    @SuppressLint("LogNotTimber")
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentCreateBannerAdBinding.bind(view)
    ...
    private fun uploadImage() {
        ...
        ApiClient.apiService.createBannerAdd(sessionManager.authToken,url,MultipartBody.Part.createFormData("file", file.name, body))
