...
public class KeyboardListenerUtils   implements ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private static HashMap<SoftKeyboardToggleListener, KeyboardListenerUtils> sListenerMap = new HashMap<>();
    ...
    public static void addKeyboardToggleListener(Activity act, SoftKeyboardToggleListener listener)
    {
        ...
        sListenerMap.put(listener, new KeyboardListenerUtils(act, listener));
    }
    ...
    public static void removeKeyboardToggleListener(SoftKeyboardToggleListener listener)
    {
        ...
        {
            KeyboardListenerUtils k = sListenerMap.get(listener);
            k.removeListener();
    ...
    private KeyboardListenerUtils(Activity act, SoftKeyboardToggleListener listener)
    {
        mCallback = listener;
