...
import com.android.sellacha.databinding.CouponItemBinding;
...
public class CouponAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CouponAdapter(Context context, ArrayList<reviewRatingDM> list) {
        this.context = context;
        this.list = list;
    }

    private RecyclerView.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup group) {
        CouponItemBinding binding = DataBindingUtil.inflate(inflater, R.layout.coupon_item, group, false);
        return new CouponAdapter.CouponAdapterHolder(binding);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        CouponAdapter.CouponAdapterHolder mHolder = (CouponAdapter.CouponAdapterHolder) holder;
    ...
    public class CouponAdapterHolder extends RecyclerView.ViewHolder {
        CouponItemBinding binding;

        public CouponAdapterHolder(CouponItemBinding itemView) {
