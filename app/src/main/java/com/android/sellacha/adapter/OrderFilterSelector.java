...
public class OrderFilterSelector extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderFilterSelector(Context context, filterItemsDM[] list, int selected, OrderFragment orderFragment) {
    ...
    private RecyclerView.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup group) {
        ...
        return new OrderFilterSelector.FilterSelectorHolder(binding);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        OrderFilterSelector.FilterSelectorHolder billsHolder = (OrderFilterSelector.FilterSelectorHolder) holder;
